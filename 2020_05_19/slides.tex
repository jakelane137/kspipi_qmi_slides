...
\newcommand{\pulldistsnm}[2]{
\pulldistnm{#1}{Comb}{Combined Tags using #2}
\pulldistnm{#1}{KK}{$\KK$ Tag using #2}
\pulldistnm{#1}{Kspi0}{$\Kspiz$ Tag using #2}
\pulldistnm{#1}{Kppim}{$\Kppim$ Tag using #2}
\pulldistnm{#1}{Kmpip}{$\Kmpip$ Tag using #2}
\pulldistnm{#1}{Kspipi}{$\Kspipi$ Tag using #2}
...
\pulldistsnm{simple}{Antisymmetric simple polynomial}
\pulldistsnm{legendre}{Antisymmetric legendre polynomial}
\pulldistsnm{chebyshev}{Antisymmetric chebyshev polynomial}
